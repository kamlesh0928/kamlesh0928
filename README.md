<a href="https://docs.google.com/document/d/1dNmpUZvLUiSKGK49ArbPkVLPLvYQV6LA/edit?usp=sharing" target="_blank">
  <img src="./assets/Hero_Image.png" alt="Kamlesh Prajapati - Full Stack Developer" style="max-width:100%; border-radius:8px;">
</a>
...
<div align="center">
    ...
    <tr>
      ...
      <td style="padding: 16px; width: 50%; vertical-align: top; text-align: left;">
        ...
        <img 
          ...
          alt="Code Parivartan Preview" 
          width="100%" 
          style="border-radius:8px; margin:12px 0;">
        <a href="https://github.com/kamlesh0928/code-parivartan" target="_blank">
          <img src="./assets/View_Button.png" alt="View Code Parivartan" width="80">
        </a>
      </td>
      <!-- Project 2 -->
      <td style="padding: 16px; width: 50%; vertical-align: top; text-align: left;">
    ...
    <tr>
      ...
      <td style="padding: 16px; width: 50%; vertical-align: top; text-align: left;">
        ...
        <a href="https://meetly-frontend-3qae.onrender.com/" target="_blank">
          <img src="./assets/View_Button.png" alt="View Meetly" width="80">
        </a>
      </td>
      <!-- Project 4 -->
      <td style="padding: 16px; width: 50%; vertical-align: top; text-align: left;">
  ...
  <div style="margin-top: 24px;">
    <a href="https://github.com/kamlesh0928?tab=repositories" target="_blank">
      <img src="./assets/View_More.png" alt="View More Projects" width="160">
    </a>
  </div>
</div>
...
<p><i>Feel free to reach out for collaborations, freelance projects, or just a tech chat!</i></p>
